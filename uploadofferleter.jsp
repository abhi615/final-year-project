...
<div class="container-fluid bg-primary  wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Upload Offer Letter</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="uploadcerti" method="post" enctype="multipart/form-data" >
                                <div class="row g-3">
