...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <<div class="container-xxl py-5 bg-primary">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s" style="color: white">Quiz Results</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div id="section">
        <br/><br/>
        <table cellpadding="10" border="2" style="color: white;border-color: white">
                <tr>
                    <th>S.No.</th>
                    <th>Name</th>
                    <th>email</th>
