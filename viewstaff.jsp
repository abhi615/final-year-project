            ...
            <div class="container">
                <table border="2">
                    ...
                    <tbody>
                        ...
                        ResultSet rs=st.executeQuery("select * from staff order by sts");
                        while(rs.next())
                        {
                        %>
                        <tr>
                            ...
                            <td><%=rs.getString("email")%></td>
                             <td><%=rs.getString("mono")%></td>
                              ...
                              <td><img src="viewimage.jsp?id=<%=rs.getInt("id")%>" width="100" height="100"></td>
                              <%
                              String sts=rs.getString("sts");
                              if(sts.equals("No"))
                              {
                                  %>
                              <td><a href="activate.jsp?id=<%=rs.getInt("id")%>">Activate</a></td>
                              <%
                              }else
                              {
                                  %>
                                    <td><a href="deactivate.jsp?id=<%=rs.getInt("id")%>">De-activate</a></td>
                              <%
                              }
                              %>
                        </tr>
