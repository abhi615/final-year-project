...
<body>
    <%
        ...
        %>
        <script>alert('Already U have Uploaded');</script>
        <%
            }
        ...
        %>
        <script>alert('Uploaded Successfull');</script>
        <%
            }%>
...
<div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Upload Project Reports</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="uploadcerti1" method="post" enctype="multipart/form-data" >
                                <div class="row g-3">
                                   
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="file" class="form-control" id="name" name="pic" required="">
                                            <label for="name">Choose Offer Letter</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-dark border-0 w-100" type="submit">Upload</button>
                                    </div>
                                     <div class="col-12">
