...
<body>
    <div class="container-xxl bg-white p-0">
       ...
       <div class="container-xxl py-5 bg-primary">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s" style="color: white">My students</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <table border="2" style="color: white;border-color: white;height: 20%;" >
                                <thead class="pl-8">
                                    <tr>
                                        <th>Student Name</th>
                                        <th>Branch</th>
                ...
                {%>
                                    <tr>
                                        <td><%=rs2.getString("sname")%></td>
                                         <td><%=rs2.getString("bran")%></td>
                                         <td><%=rs2.getString("sem")%></td>
                                         <td><img src="viewstdprofile.jsp?id=<%=rs2.getInt("id")%>" width="100" height="100"></td>
                                         <td><a href="viewpdairyres.jsp?sname=<%=rs2.getString("sname")%>">View Prokter Diary</a></td>
                                    </tr>
                                    <%}}}%>
                                </tbody>
