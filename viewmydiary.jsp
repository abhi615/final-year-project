...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">My Project Diary</h1>
                <div class="row g-4">
        ...
        if(rs2.next())
        {
            ...
            System.out.println("remarks=="+remarks);
                                    ...
                                    <tr>
                                        <td><h1>Project Progress of 1st Review</h1></td>
                                    </tr>
                                    <tr> 
                                        <td>From date</td>
        ...
        if(rs3.next())
        {
            ...
            System.out.println("remarks=="+remarks);
                                    ...
                                    <tr>
                                        <td><h1>Project Progress of 2nd Review</h1></td>
                                    </tr>
                                    <tr> 
                                        <td>From date</td>
        ...
        if(rs4.next())
        {
            ...
            System.out.println("remarks=="+remarks);
                                    ...
                                    <tr>
                                        <td><h1>Project Progress of 3rd Review</h1></td>
                                    </tr>
                                    <tr> 
                                        <td>From date</td>
        ...
        if(rs5.next())
        {
            ...
            System.out.println("remarks=="+remarks);
                                    ...
                                    <tr>
                                        <td><h1>Project Progress of 4th Review</h1></td>
                                    </tr>
                                    <tr> 
                                        <td>From date</td>
        ...
        if(rs6.next())
        {
            ...
            System.out.println("remarks=="+remarks);
                                    ...
                                    <tr>
                                        <td><h1>Project Progress of 5th Review</h1></td>
                                    </tr>
                                    <tr> 
                                        <td>From date</td>
        ...
        ResultSet rs7=st7.executeQuery("SELECT * FROM pprogress5 where sname='"+sname+"'");
        if(rs7.next())
        {
            ...
            System.out.println("remarks=="+remarks);
                                    ...
                                    <tr>
                                        <td><h1>Project Progress of 6th Review</h1></td>
                                    </tr>
                                    <tr> 
                                        <td>From date</td>
