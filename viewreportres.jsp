...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">My students</h1>
                <div class="row g-4">
                ...
                ResultSet rs2=st2.executeQuery("select * from studpupload where sname='"+studname+"' ");
                if(rs2.next())
                {%>
                                    <tr>
                                        <td><%=rs2.getString("sname")%></td>
                                         
                                        <td><a href="download.jsp?id=<%=rs2.getInt("id")%>">Download</a></td>
