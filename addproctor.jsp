...
<body>
    <%
        ...
        %>
        <script>alert('Assigned Success');</script>
        <%
            }
    %>
    <div class="container-xxl bg-white p-0">
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="addproctor.jsp" class="dropdown-item">Add Students</a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Assigning Students</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="assign.jsp" method="post" >
                                <div class="row g-3">
                                        ...
                                        <div class="form-floating">
                                            <select name="sname" class="form-control">
                                                <%
                                                    ...
                                                    {
                                                %>
                                                <option value="<%=rs.getInt("id")%>"><%=rs.getString("sname")%></option>
                                                <%}%>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select name="stid" multiple="multiple" class="form-control">
                                                <%
                                                    Statement st1=con.createStatement();
                                                    ResultSet rs1=st1.executeQuery("select * from stud");
                                                    while(rs1.next())
                                                    {
                                                %>
                                                <option value="<%=rs1.getInt("id")%>"><%=rs1.getString("sname")%></option>
                                                <%}%>
                                            </select>
