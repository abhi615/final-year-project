...
<body>
     <%
        ...
        %>
        <script>alert('Response submitted');</script>
        <%
            }%>
    <div class="container-xxl bg-white p-0">
       ...
       <div class="container-xxl py-5 bg-primary">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s"style="color: white">Meeting Details</h1>
                <div class="row g-4">
        ...
        ResultSet rs=st.executeQuery("select * from meeting where stdname='"+uname+"'");
        while(rs.next())
        {
            %>
                                    <tr>
                                        <td><%=rs.getString("sname")%></td>
                                         ...
                                         <td><a href="meetingres.jsp?id=<%=rs.getInt("id")%>">Response</a></td>
