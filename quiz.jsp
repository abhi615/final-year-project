...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Search Start -->
        <div id="section" class="bg-primary">
    ...
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button id="start" style="width:60px;height:30px;background-color: black;color: white;margin-bottom: 50px" onClick="parent.location='test.jsp'">Start</button>    
    </div>
        <!-- About End -->
