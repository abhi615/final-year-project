...
<div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Add Project Abstract</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="addprojectabs.jsp" method="post" >
                                <div class="row g-3">
                                    <table border="1">
                                        <thead>
                                            <tr>
                                                <th colspan="2" style="text-align: center">Project Abstract</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" name="pname" value="" size="20" required="" /></td>
                                            </tr>
                                            <tr>
                                                <td>Abstract</td>
                                                <td><textarea class="form-control" name="abst" rows="4" cols="20" required="">
                                                    </textarea></td>
                                            </tr>
