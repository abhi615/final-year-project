...
<body>
     <%
        ...
        %>
        <script>alert('Placement Added');</script>
        <%
            }
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid bg-primary  wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Add Placement Details</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="addp.jsp" method="post" >
                                <div class="row g-3">
                                   
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="datetime-local" class="form-control" id="name" name="dat" required="">
                                            <label for="name">Select placement Date and time</label>
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" name="cname" placeholder="company name" required="">
                                            <label for="name">Company Name</label>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" name="jt" placeholder="Job Title" required="">
                                            <label for="name">Job Title</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" name="ec" placeholder="Eligible Criteria in percentage" required="">
                                            <label for="name">Eligible Criteria</label>
                                        </div>
                                    </div>
