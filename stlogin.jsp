...
<body>
     <%
        ...
        %>
        <script>alert('Account Not activated');</script>
        <%
            }
        %>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Staff Login</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="stlog.jsp" method="post" >
                                <div class="row g-3">
