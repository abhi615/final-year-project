...
<% String sname=session.getAttribute("uname").toString();
        ...
        ResultSet rs=st.executeQuery("select * from pprogress2 where sname='"+sname+"'");
        if(rs.next())
        {
            response.sendRedirect("progress3.jsp");
        }else
        {
%><html lang="en">
...
<div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Add Progress for Month2</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="pro2action.jsp" method="post" >
                                <div class="row g-3">
