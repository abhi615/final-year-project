...
<body>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Student Login</h1>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="slog.jsp" method="post" >
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-dark border-0 w-100" type="submit">Login</button>
                                    </div>
                                     <div class="col-12">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="http://projectinstitutie.in/">Mindsoft</a>
                        </div>
