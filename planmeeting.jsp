...
<html lang="en">
    ...
    <body>
        ...
        %>
        <script>alert('Meeting Scheduled');</script>
        <%
            }
        ...
        <div class="container-xxl bg-white p-0">
            ...
            <div class="container-xxl py-5 bg-primary">
                <div class="container">
                    <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s" style="color: white">Plan Meeting</h1>
                    <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <form name="streg" action="meet.jsp" method="post" >
                                <div class="row g-3">

                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="datetime-local" class="form-control" id="name" name="dat" required="">
                                            <label for="name">Select Meeting Date and time</label>
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="name" name="sub" placeholder="Meeting Regarding" required="">
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-dark border-0 w-100" type="submit">Schedule</button>
                                    </div>
                                    <div class="col-12">
