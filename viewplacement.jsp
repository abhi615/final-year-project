...
<body>
    <div class="container-xxl bg-white p-0">
       ...
       <div class="container-xxl py-5 bg-primary">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s" style="color: white">Placement Details</h1>
                <div class="row g-4">
        ...
        ResultSet rs=st.executeQuery("select * from req order by pdat desc");
        while(rs.next())
        {
            %>
                                    <tr>
                                        <td><%=rs.getString("cname")%></td>
                                         <td><%=rs.getString("jt")%></td>
                                         <td><%=rs.getDouble("ec")%>%</td>
                                         <td><%=rs.getString("dat")%></td>
                                         <td><%=rs.getString("pdat")%></td>
